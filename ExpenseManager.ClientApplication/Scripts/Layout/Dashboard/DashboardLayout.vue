<template>
  <div class="wrapper">
    <side-bar :title="applicationName">
      <template slot="links">
        <sidebar-link to="/dashboard" name="Dashboard" icon="ti-panel"/>
        <sidebar-link to="/categories" name="categories" icon="ti-world"/>
...
import SidebarLink from '@scripts/components/SidebarPlugin/SidebarLink.vue';
export default {
  components: {
    TopNavbar,
    ContentFooter,
